...
public class ValidationMessages {
    ...
    public static final String BUSQO_INTERNAL_SERVER_ERROR_CODE = "INS_103";
    public static final String BUSQO_INTERNAL_SERVER_ERROR_MESSAGE = "Error 500 consumiendo el servicio de Busqo";
